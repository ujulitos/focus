...
var grupoAudios = new buzz.group([
    ...
    /*06*/ new buzz.sound("contenido/audios/audio0", { formats: ["mp3"], preload: true }),
    /*07*/ new buzz.sound("contenido/audios/05", { formats: ["mp3"], preload: true }),
    /*08*/ new buzz.sound("contenido/audios/06", { formats: ["mp3"], preload: true }),
    /*09*/ new buzz.sound("contenido/audios/07", { formats: ["mp3"], preload: true }),
    /*10*/ new buzz.sound("contenido/audios/08", { formats: ["mp3"], preload: true }),
    /*11*/ new buzz.sound("contenido/audios/09", { formats: ["mp3"], preload: true }),
    /*12*/ new buzz.sound("contenido/audios/10", { formats: ["mp3"], preload: true }),
    ...
    /*18*/ new buzz.sound("contenido/audios/16", { formats: ["mp3"], preload: true }),
    /*19*/ new buzz.sound("contenido/audios/17", { formats: ["mp3"], preload: true }),
    /*20*/ new buzz.sound("contenido/audios/18", { formats: ["mp3"], preload: true }),
    /*21*/ new buzz.sound("contenido/audios/19", { formats: ["mp3"], preload: true }),
    /*22*/ new buzz.sound("contenido/audios/20", { formats: ["mp3"], preload: true }),
    /*23*/ new buzz.sound("contenido/audios/21", { formats: ["mp3"], preload: true }),

    /*24*/ new buzz.sound("contenido/audios/audio0", { formats: ["mp3"], preload: true }),
    /*25*/ new buzz.sound("contenido/audios/22", { formats: ["mp3"], preload: true }),
    /*26*/ new buzz.sound("contenido/audios/23", { formats: ["mp3"], preload: true }),    
    /*27*/ new buzz.sound("contenido/audios/24", { formats: ["mp3"], preload: true }),    
    /*28*/ new buzz.sound("contenido/audios/25", { formats: ["mp3"], preload: true }),

    /*29*/ new buzz.sound("contenido/audios/audio0", { formats: ["mp3"], preload: true }),
    ...
    /*34*/ new buzz.sound("contenido/audios/audio0", { formats: ["mp3"], preload: true }),
    /*35*/ new buzz.sound("contenido/audios/29", { formats: ["mp3"], preload: true }),

    /*36*/ new buzz.sound("contenido/audios/30", { formats: ["mp3"], preload: true })
]);
