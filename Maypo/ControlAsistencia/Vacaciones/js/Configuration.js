...
course.pages = [
    ...
    { title: "Pantalla", url: "Maypo_ControlAsistencia_07.html", navegacion: true, menu: true },
    { title: "Pantalla", url: "Maypo_ControlAsistencia_08.html", navegacion: true, menu: true }
];
...
var grupoAudios = new buzz.group([
    ...
    /*15*/ new buzz.sound("contenido/audios/12", { formats: ["mp3"], preload: true }),
    /*16*/ new buzz.sound("contenido/audios/13", { formats: ["mp3"], preload: true }),
    /*17*/ new buzz.sound("contenido/audios/14", { formats: ["mp3"], preload: true }),
    /*18*/ new buzz.sound("contenido/audios/15", { formats: ["mp3"], preload: true }),
    ...
    /*30*/ new buzz.sound("contenido/audios/25", { formats: ["mp3"], preload: true }),
    /*31*/ new buzz.sound("contenido/audios/26", { formats: ["mp3"], preload: true }),

    /*32*/ new buzz.sound("contenido/audios/27", { formats: ["mp3"], preload: true }),
]);
