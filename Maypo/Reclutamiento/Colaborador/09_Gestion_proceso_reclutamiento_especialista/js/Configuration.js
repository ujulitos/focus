...
course.pages = [
    ...
    { title: "Pantalla", url: "Maypo_07.html", navegacion: true, menu: true },
    { title: "Pantalla", url: "Maypo_08.html", navegacion: true, menu: true }
];
...
var grupoAudios = new buzz.group([
    ...
    /*48*/ new buzz.sound("contenido/audios/47", { formats: ["mp3"], preload: true }),
