...
course.pages = [
    ...
    { title: "Pantalla", url: "Maypo_05.html", navegacion: true, menu: true },
    { title: "Pantalla", url: "Maypo_06.html", navegacion: true, menu: true }
];
...
var grupoAudios = new buzz.group([
    ...
    /*40*/ new buzz.sound("contenido/audios/39", { formats: ["mp3"], preload: true }),
    /*41*/ new buzz.sound("contenido/audios/40", { formats: ["mp3"], preload: true }),
    /*42*/ new buzz.sound("contenido/audios/41", { formats: ["mp3"], preload: true }),
    /*43*/ new buzz.sound("contenido/audios/42", { formats: ["mp3"], preload: true }),
    /*44*/ new buzz.sound("contenido/audios/43", { formats: ["mp3"], preload: true }),
    /*45*/ new buzz.sound("contenido/audios/44", { formats: ["mp3"], preload: true }),
    /*46*/ new buzz.sound("contenido/audios/45", { formats: ["mp3"], preload: true }),    
    /*47*/ new buzz.sound("contenido/audios/46", { formats: ["mp3"], preload: true }),

    /*48*/ new buzz.sound("contenido/audios/audio0", { formats: ["mp3"], preload: true }),
    /*49*/ new buzz.sound("contenido/audios/48", { formats: ["mp3"], preload: true }),
    /*50*/ new buzz.sound("contenido/audios/49", { formats: ["mp3"], preload: true }),
    /*51*/ new buzz.sound("contenido/audios/50", { formats: ["mp3"], preload: true }),
    /*52*/ new buzz.sound("contenido/audios/51", { formats: ["mp3"], preload: true }),
    /*53*/ new buzz.sound("contenido/audios/52", { formats: ["mp3"], preload: true }),
    /*54*/ new buzz.sound("contenido/audios/53", { formats: ["mp3"], preload: true }),
    /*55*/ new buzz.sound("contenido/audios/54", { formats: ["mp3"], preload: true }),
    /*56*/ new buzz.sound("contenido/audios/55", { formats: ["mp3"], preload: true }),

    /*57*/ new buzz.sound("contenido/audios/56", { formats: ["mp3"], preload: true })
]);
