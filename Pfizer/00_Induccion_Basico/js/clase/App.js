...
function desactivarBotonRecargar() {
    btnRecargar.prop('disabled', true);
    btnRecargar.removeClass('activado');
    btnRecargar.addClass('desactivado');
}
...
function activarBotonRecargar() {
    btnRecargar.prop('disabled', false);
    btnRecargar.removeClass('desactivado');
    btnRecargar.addClass('activado');
}

function bloquearNavegacion() {
    desactivarBotonAtras();
    desactivarBotonAdelante();
    desactivarBotonRecargar();
}

function desbloquearNavegacion() {
    activarBotonAtras();
    activarBotonAdelante();
    activarBotonRecargar();
}
...
function reiniciaPuntaje() {
    puntaje = 0;
    console.log('Se reinicia el puntaje a:', puntaje);
    return puntaje;
}
...
function addPuntaje(cuantosPuntos) {
    puntaje += cuantosPuntos;
    console.log('Se añadieron', puntaje, ' puntos');
}
