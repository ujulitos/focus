function inicializaAPI() {
    ...
    function leeDatosSCORM() {
        ...
        if (revisaConexion) {
            ...
            var elRefDatos = laUrlBase + 'Sesiones/' + laSesionActual + '/Registro/' + usuarioId + '/Modulos/modulo_' + elModulo + '/Recursos/recurso_' + elRecurso + '/' + that['laSesion_Leccion' + '_Modulo' + elModulo + '_Recurso' + elRecurso + '_Id'] + '/SCORM_12/';
    ...
    function escribeDatosSCORM(param, val) {
        ...
        if (revisaConexion) {
            ...
            var elRefDatos = laUrlBase + 'Sesiones/' + laSesionActual + '/Registro/' + usuarioId + '/Modulos/modulo_' + elModulo + '/Recursos/recurso_' + elRecurso + '/' + that['laSesion_Leccion' + '_Modulo' + elModulo + '_Recurso' + elRecurso + '_Id'] + '/SCORM_12/' + nuevoParam + '';
    ...
    function LMSGetValue(param) {
        ...
        if (param == 'cmi.core._children' || param == 'cmi.core_children') {
            result = 'entry, exit, cmi_core_lesson_status, student_id, student_name, cmi_core_lesson_location, total_time, credit, lesson_mode, score, cmi_core_session_time';
