...
var laUrlBase = "Onboarding2/";
var laUrlAPI = "https://bimbopre.firebaseio.com/Onboarding2";
...
var el_sub;
var el_sub_par;
this.arrayStatusWeeks_ibp = [];
this.arrayStatusWeeks_coach = [];
this.arrayStatusDays_ibp = [];
this.arrayStatusDays_coach = [];
this.arrayStatusCats_ibp = [];
this.arrayStatusCats_coach = [];
const arregloJson = [];
_that = this;
