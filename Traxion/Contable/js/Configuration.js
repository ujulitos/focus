...
var grupoAudios = new buzz.group([
    ...
    /*91*/ new buzz.sound("contenido/audios/Oracle_01", { formats: ["mp3"], preload: true }),
    /*92*/ new buzz.sound("contenido/audios/Oracle_02", { formats: ["mp3"], preload: true }),
    /*93*/ new buzz.sound("contenido/audios/Oracle_03", { formats: ["mp3"], preload: true }),
    /*94*/ new buzz.sound("contenido/audios/Oracle_04", { formats: ["mp3"], preload: true }),
    /*95*/ new buzz.sound("contenido/audios/Oracle_05", { formats: ["mp3"], preload: true }),
    /*96*/ new buzz.sound("contenido/audios/Oracle_06", { formats: ["mp3"], preload: true }),
    /*97*/ new buzz.sound("contenido/audios/Oracle_07", { formats: ["mp3"], preload: true }),
    /*98*/ new buzz.sound("contenido/audios/Oracle_08", { formats: ["mp3"], preload: true }),
    /*99*/ new buzz.sound("contenido/audios/RepNomina_01", { formats: ["mp3"], preload: true }),
    /*100*/ new buzz.sound("contenido/audios/RepNomina_03", { formats: ["mp3"], preload: true }),
    /*101*/ new buzz.sound("contenido/audios/RepNomina_04", { formats: ["mp3"], preload: true }),
    /*102*/ new buzz.sound("contenido/audios/RepNomina_05", { formats: ["mp3"], preload: true }),
    /*103*/ new buzz.sound("contenido/audios/RepNomina_06", { formats: ["mp3"], preload: true }),
    /*104*/ new buzz.sound("contenido/audios/RepNomina_07", { formats: ["mp3"], preload: true }),
    /*105*/ new buzz.sound("contenido/audios/RepNomina_08", { formats: ["mp3"], preload: true }),
    /*106*/ new buzz.sound("contenido/audios/RepNomina_09", { formats: ["mp3"], preload: true }),
    /*107*/ new buzz.sound("contenido/audios/RepNomina_10", { formats: ["mp3"], preload: true }),
    /*108*/ new buzz.sound("contenido/audios/RepNomina_11", { formats: ["mp3"], preload: true }),
    /*109*/ new buzz.sound("contenido/audios/RepNomina_12", { formats: ["mp3"], preload: true }),
    /*110*/ new buzz.sound("contenido/audios/RepNomina_13", { formats: ["mp3"], preload: true }),
    /*111*/ new buzz.sound("contenido/audios/RepNomina_14", { formats: ["mp3"], preload: true }),
]);
