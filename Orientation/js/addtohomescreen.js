...
(function (window, document) {
    ...
    */
    ...
    ath.intl = {
        ...
        en_us: {
            ios: 'To add this web application to the home screen: press %icon and select <strong>Add to home screen</strong>.',
            android: 'To add this web application to the home screen, open the options and press <strong>Add to home screen</strong>. <small>The menu can be accessed by pressing the touch button if there is one, or the icon at the top right of the screen %icon.</small>'
        },
