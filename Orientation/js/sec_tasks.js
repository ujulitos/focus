 function activaSeccionTasks() {
     ...
     function pintaTasks(data) {
         ...
         for (b = 1; b <= that['cat' + laSemana + '_cuantasSubcategorias' + laCategoria]; b++) {
            ...
            if(laSemana == 1 && laCategoria == 2){
                // TODO: Tarea classroom
                contenidoTasks += '<div id="Classroom Day" class="boton_tool">Classroom Day</div>';
            }
             
            if(laSemana == 2 && laCategoria == 2){
                // TODO: Tarea classroom
                contenidoTasks += '<div id="Classroom Day" class="boton_tool">Classroom Day</div>';
            }
             
            if(laSemana == 3 && laCategoria == 2){
                // TODO: Tarea classroom
                contenidoTasks += '<div id="Classroom Day" class="boton_tool">Classroom Day</div>';
            }
             
            if(laSemana == 5 && laCategoria == 1){
                // TODO: Tarea classroom
                contenidoTasks += '<div id="Classroom Day" class="boton_tool">Classroom Day</div>';
            }

            console.log('Mi semana', laSemana);
            console.log('Mi cetegoria', laCategoria);
     ...
     switch (cualTool) {
         ...
         case "Distribution_Agreement":
             ...
             Swal.fire({
                ...
                // html: '<iframe src="http://docs.google.com/gview?url=https://www.orientationbbu.com/docs/web/Distribution_Agreement468.pdf&embedded=true" type="application/pdf" style="min-height:80vh; width:100%"></iframe>',
                html: '<embed src="../docs/web/Distribution_Agreement468.pdf#toolbar=0&navpanes=0&scrollbar=0" type="application/pdf" width="100%" height="600px" id="pdfEmbed" />',
                didOpen: () => {
                    const pdfEmbed = document.querySelector('#pdfEmbed');
                    pdfEmbed.oncontextmenu = function(event) {
                        event.preventDefault();
         ...
         case "Classroom Day":
             ...
             Swal.fire({
                 title: 'Classroom Day',
                //  html: '<iframe src="http://docs.google.com/gview?url=https://www.orientationbbu.com/docs/web/Classroom_Day_Agendas.pdf&embedded=true" type="application/pdf" style="min-height:80vh; width:100%"></iframe>',
                 html: '<embed src="../docs/web/Classroom_Day_Tools.pdf#toolbar=0&navpanes=0&scrollbar=0" type="application/pdf" width="100%" height="600px" id="pdfEmbed" />',
                 showCloseButton: true,
                 showConfirmButton: false,
                 heightAuto: true,
                 width: '100%',
         ...
         case "Handheld_(HHC)":
             ...
             Swal.fire({
                 title: 'Handheld (HHC)',
                 html: '<iframe src="http://docs.google.com/gview?url=https://www.orientationbbu.com/docs/web/Handheld_(HHC).pdf&embedded=true" type="application/pdf" style="min-height:80vh; width:100%"></iframe>',
                 showCloseButton: true,
                 showConfirmButton: false,
                 heightAuto: true,
                 width: '100%',
         ...
         case "Safe_Carry_Over_(SCO)":
             ...
             Swal.fire({
                 ...
                 html: '<iframe src="http://docs.google.com/gview?url=https://www.orientationbbu.com/docs/web/Safe_Carry_Over_(SCO).pdf&embedded=true" style="min-height:80vh; width:100%"></iframe>',
                 showCloseButton: true,
                 showConfirmButton: false,
                 heightAuto: true,
                 width: '100%',
         ...
         case "Settlement":
             ...
             Swal.fire({
                 title: 'Settlement',
                 html: '<iframe src="http://docs.google.com/gview?url=https://www.orientationbbu.com/docs/web/Settlement.pdf&embedded=true" type="application/pdf" style="min-height:80vh; width:100%"></iframe>',
                 showCloseButton: true,
                 showConfirmButton: false,
                 heightAuto: true,
                 width: '100%',
             ...
             break;
         case "Market Golden Path":
             // window.open('docs/SETTLEMENT.pdf');
             //  window.open('http://docs.google.com/viewer?url=' + laURL + 'docs/SETTLEMENT.pdf');
             Swal.fire({
                 title: 'Market Golden Path',
                 html: '<iframe src="http://docs.google.com/gview?url=https://www.orientationbbu.com/docs/web/Market_GoldenPath.pdf&embedded=true" type="application/pdf" style="min-height:80vh; width:100%"></iframe>',
                 showCloseButton: true,
                 showConfirmButton: false,
                 heightAuto: true,
                 width: '100%',
         ...
         case "Market Golden Path":
             ...
             break;
         case "Market Secondary Display":
             // window.open('docs/SETTLEMENT.pdf');
             //  window.open('http://docs.google.com/viewer?url=' + laURL + 'docs/SETTLEMENT.pdf');
             Swal.fire({
                 title: 'Market Secondary Display',
                 html: '<iframe src="http://docs.google.com/gview?url=https://www.orientationbbu.com/docs/web/Market_SecondaryDisplay.pdf&embedded=true" type="application/pdf" style="min-height:80vh; width:100%"></iframe>',
                 showCloseButton: true,
                 showConfirmButton: false,
                 heightAuto: true,
                 width: '100%',
             ...
             break;
         case "Aramark Clothing Options":
             // window.open('docs/SETTLEMENT.pdf');
             //  window.open('http://docs.google.com/viewer?url=' + laURL + 'docs/SETTLEMENT.pdf');
             Swal.fire({
                 title: 'Aramark Clothing Options & order Form',
                 html: '<iframe src="http://docs.google.com/gview?url=https://www.orientationbbu.com/docs/web/Aramark_Clothing_Options_and_Order_Form.pdf&embedded=true" type="application/pdf" style="min-height:80vh; width:100%"></iframe>',
                 showCloseButton: true,
                 showConfirmButton: false,
                 heightAuto: true,
                 width: '100%',
         ...
         case "SBT Introduction":
             ...
             Swal.fire({
                 ...
                 html: '<iframe src="http://docs.google.com/gview?url=https://www.orientationbbu.com/docs/web/Scan_Based_Trading_(SBT)_Introduction.pdf&embedded=true" type="application/pdf" style="min-height:80vh; width:100%"></iframe>',
                 showCloseButton: true,
                 showConfirmButton: false,
                 heightAuto: true,
                 width: '100%',
         ...
         case "Scan Based Trading SBT":
             ...
             Swal.fire({
                 ...
                 html: '<iframe src="http://docs.google.com/gview?url=https://www.orientationbbu.com/docs/web/ScanBasedTradingSBT9-22-22.pdf&embedded=true" type="application/pdf" style="min-height:80vh; width:100%"></iframe>',
                 showCloseButton: true,
                 showConfirmButton: false,
                 heightAuto: true,
                 width: '100%',
