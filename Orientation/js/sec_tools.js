    ...
    function descargaTool(cualTool) {
        ...
        switch (cualTool) {
            case 1:
                ...
                Swal.fire({
                    title: 'Aramark Clothing Options',
                    html: '<iframe id="pdfFrame" src="http://docs.google.com/gview?url=https://www.orientationbbu.com/docs/web/Aramark_Clothing_Options_and_Order_Form.pdf&embedded=true" style="min-height:80vh; width:100%"></iframe>',
            ...
            case 2:
                ...
                Swal.fire({
                    ...
                    html: '<iframe id="pdfFrame" src="http://docs.google.com/gview?url=https://www.orientationbbu.com/docs/web/Distribution_Agreement468.pdf&embedded=true" type="application/pdf" style="min-height:80vh; width:100%"></iframe>',
                    showCloseButton: true,
                    showConfirmButton: false,
                    heightAuto: false,
                    width: '100%',
            ...
            case 3:
                ...
                Swal.fire({
                    ...
                    html: '<iframe src="http://docs.google.com/gview?url=https://www.orientationbbu.com/docs/web/ION_Introduction.pdf&embedded=true&navpanes=0&scrollbar=0" type="application/pdf" style="min-height:80vh; width:100%"></iframe>',
                    showCloseButton: true,
                    showConfirmButton: false,
                    heightAuto: true,
                    width: '100%',
            ...
            //     // window.open('http://docs.google.com/viewer?url=' + laURL + 'docs/ION_SetUp.pdf');
                Swal.fire({
                    title: 'Classroom Day',
                    html: '<iframe src="http://docs.google.com/gview?url=https://www.orientationbbu.com/docs/web/Classroom_Day_Tools.pdf&embedded=true" type="application/pdf" style="min-height:80vh; width:100%"></iframe>',
                    showCloseButton: true,
                    showConfirmButton: false,
                    heightAuto: true,
                    width: '100%',
            ...
            case 26:
                ...
                Swal.fire({
                    ...
                    html: '<iframe src="http://docs.google.com/gview?url=https://www.orientationbbu.com/docs/web/Safe_Carry_Over_(SCO).pdf&embedded=true&navpanes=0&scrollbar=0" type="application/pdf" style="min-height:80vh; width:100%"></iframe>',
                    showCloseButton: true,
                    showConfirmButton: false,
                    heightAuto: true,
                    width: '100%',
            ...
            case 27:
                ...
                Swal.fire({
                    ...
                    html: '<iframe src="http://docs.google.com/gview?url=https://www.orientationbbu.com/docs/web/ScanBasedTradingSBT9-22-22.pdf&embedded=true&navpanes=0&scrollbar=0" type="application/pdf" style="min-height:80vh; width:100%"></iframe>',
                    showCloseButton: true,
                    showConfirmButton: false,
                    heightAuto: true,
                    width: '100%',
            ...
            case 28:
                ...
                Swal.fire({
                    ...
                    html: '<iframe src="http://docs.google.com/gview?url=https://www.orientationbbu.com/docs/web/Scan_Based_Trading_(SBT).pdf&embedded=true&navpanes=0&scrollbar=0" type="application/pdf" style="min-height:80vh; width:100%"></iframe>',
                    showCloseButton: true,
                    showConfirmButton: false,
                    heightAuto: true,
                    width: '100%',
            ...
            case 29:
                ...
                Swal.fire({
                    title: 'Settlement',
                    html: '<iframe src="http://docs.google.com/gview?url=https://www.orientationbbu.com/docs/web/Settlement.pdf&embedded=true&navpanes=0&scrollbar=0" type="application/pdf" style="min-height:80vh; width:100%"></iframe>',
                    showCloseButton: true,
                    showConfirmButton: false,
                    heightAuto: true,
                    width: '100%',
            ...
            case 30:
                ...
                // window.open('http://docs.google.com/viewer?url=' + laURL + 'docs/SETTLEMENT.pdf');
                Swal.fire({
                    title: 'RTM Library – OTS Application',
                    html: '<iframe src="http://docs.google.com/gview?url=https://www.orientationbbu.com/docs/web/RTMLibrary-OTSapplication.pdf&embedded=true&navpanes=0&scrollbar=0" type="application/pdf" style="min-height:80vh; width:100%"></iframe>',
                    showCloseButton: true,
                    showConfirmButton: false,
                    heightAuto: true,
                    width: '100%',
