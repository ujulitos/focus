...
function registraIniciado(speedMbps) {
    ...
    var elRefIniciado = parent.laUrlBase + '/Lecciones/' + parent.usuarioId + parent.elCurso + '/objeto_' + parent['CursoId' + parent.elContenido];
...
function registraDato(param, value) {
    ...
    if (elCliente != undefined) {
        if (revisaConexion) {
            // firebase.database().ref(laUrlBase + '/' + elCliente + '/' + elProyecto + '/' + elStudentId + '/SCORM_12').update(
            firebase.database().ref(parent.laUrlBase + '/Lecciones/' + parent.usuarioId + parent.elCurso + '/objeto_' + parent['CursoId' + parent.elContenido] + '/SCORM_12').update(
...
//             var elRefRevisado = parent.laUrlBase + 'Lecciones/' + parent.usuarioId + parent.elCurso + '/objeto_' + parent['CursoId' + parent.elContenido];
