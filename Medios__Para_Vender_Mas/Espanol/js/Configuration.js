...
course.pages = [{
        title: "eLearning",
        url: "BIMBO_MediosVenderMas.html",
        navegacion: true,
        menu: true
    }
...
var grupoAudios = new buzz.group([
    /*0*/
    new buzz.sound("contenido/audios/audio0", {
        formats: ["mp3"],
        preload: true
    }),
    /*1*/
    ...
    /*2*/
    new buzz.sound("contenido/audios/correcto", {
        formats: ["mp3"],
        preload: true
    }),
    /*3*/
    new buzz.sound("contenido/audios/error", {
        formats: ["mp3"],
        preload: true
    }),
    /*4*/
    new buzz.sound("contenido/audios/musica", {
        formats: ["mp3"],
        preload: true
    })
]);
