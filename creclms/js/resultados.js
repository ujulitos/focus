                ...
                if (snapshot.val() != null) {
                    ...
                    childSnapshot.forEach(function(childSnapshot2) {
                        ...
                        if (childSnapshot2.key.split('oc')[1] == '') {
                            ...
                            // console.log('leeLeccionesRes', contador, childSnapshot.key, childSnapshot2.key, those['usuarioId' + contador], those['usuarioPerfilInt' + contador]);
...
function cuentaLeccionesRes() {
    console.log('cuentaLeccionesRes');
                    ...
                    if (childSnapshot.key != undefined && childSnapshot.key != null && childSnapshot.key != '' && childSnapshot.key != 'undefined') {
                        ...
                        childSnapshot.forEach(function(childSnapshot2) {
                            childSnapshot2.forEach(function(childSnapshot3) {
                                ...
                                console.log('laFechaCierra', contadorRecAsig, this['laFechaCierra' + contadorRecAsig]);
...
function pintaResultados() {
    ...
    for (a = 1; a <= cuantosRecursos; a++) {
        ...
        // console.log('laFechaFormat', laFechaFormat);
