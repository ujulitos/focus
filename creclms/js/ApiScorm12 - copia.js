function inicializaAPI() {
    ...
    function leeDatosSCORM() {
        ...
        if (revisaConexion) {
            ...
            var elRefDatos = laUrlBase + 'Lecciones/' + usuarioId + elCurso + '/objeto_' + Key_oc + elSufijo + '/SCORM_12/';
    ...
    function escribeDatosSCORM(param, val) {
        ...
        if (revisaConexion) {
            ...
            var elRefDatos = laUrlBase + 'Lecciones/' + usuarioId + '/' + elCurso + 'objeto_' + Key_oc + elSufijo + '/SCORM_12/' + nuevoParam + '';
        ...
        if (lesson_status_registrado != 'passed') {
            ...
            if (param == "cmi.core.score.raw") {
                ...
                if (val == '' || val == null || val == undefined) {
                    ...
                    if (elResult_lesson_status == 'passed') {
                        val = '';
                        suspend_data = val;
                        f_suspend_data = val;
                    } else {
