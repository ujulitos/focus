...
function initCourse() {
    ...
    $("#btnPrev, #btnNext").mouseover(function () {
        if ($(this).hasClass('btnNavOver')) {
            if (!bloqueoGral && !bloqueoRegreso) {
                $(this).css({
                    'filter': 'brightness(0.5) sepia(0.1) saturate(100%)'
                })
            }
        }
    });
    $("#btnPrev, #btnNext").mouseout(function () {
        $(this).css({
            'filter': 'brightness(0.8) sepia(1) saturate(0%)'
        })
    });
...
function setScale() {
    ...
    if (pantallaCompleta) {
        ...
        $('#progress').css("-ms-transform", "scale(" + 1 + "," + scaleTemplate + ")");
        $('#progress').css("-webkit-transform", "scale(" + 1 + "," + scaleTemplate + ")");
        $('#progress').css("transform", "scale(" + 1 + "," + scaleTemplate + ")");
        ...
        // $('#progressBar').css("bottom", "" + (22 * scaleTemplate) + "px");
        $('#progressBar').css("left", "" + (500 * scaleTemplate) + "px");
        $('#progressBar').css("bottom", "" + (3.5 * scaleTemplate) + "%");

        // $('#progressDatos').css("top", "" + (15 * scaleTemplate) + "px");
        $('#progressDatos').css("left", "" + (130 * scaleTemplate) + "px");
